...
import { findNodeByPath, findNodeByIndex, findFirstLeaf, expandToPath, buildDirectory as buildTree } from '../tree.js';

/* ── Build directory tree from records ── */

function buildDirectory(state) {
    state.directory = buildTree(state.records, state.chapterField || DEFAULTS.chapterField);
}
