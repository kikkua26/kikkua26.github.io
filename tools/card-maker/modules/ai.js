...
## 标记规范
- **重点标记**：关键术语、核心定义、重要数据用【【……】】标记。例如：麻黄的功效是【【发汗解表】】、【【宣肺平喘】】,-禁止在json里面使用半角双引号！
- **名词解释**：专业术语在正文中用【*术语::解释*】格式内联标注，不单独设字段。例如：此方具有【*辛温::指用温性药物驱散寒邪*】解表之功

## 字段组织
- **章节**：用户提供了章节信息则保留，否则根据内容推断
- **知识解析**（核心必记）：放该知识点最重要的内容，如定义、组成、功效、主治、核心机制等，是必须掌握的部分，字段名自行拟定
- **拓展解析**（辅助了解）：放拓展和补充内容，如临床应用、鉴别对比、方解分析、使用注意、相关方剂等，帮助加深理解但非必须记忆，字段名控制在2个字
